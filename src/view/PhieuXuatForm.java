...
public class PhieuXuatForm extends JInternalFrame {
	...
	private static String[] columName = { "ID đơn xuất", "ID khách hàng", "Thời gian xuất hàng", "Người tạo đơn",
...
//		                jExcelFilePath.setText(excelFile.toString());
		...
		comboBox = new JComboBox<String>(new DefaultComboBoxModel<String>(new String[] { "ID đơn xuất",
				"ID khách hàng", "Thời gian xuất", "Người tạo", "Tổng tiền", "Trạng thái" }));
